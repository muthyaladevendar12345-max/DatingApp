...
namespace API.Data.Migrations
{
    ...
    [Migration("20260404053352_massegeentity")]
    partial class massegeentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.MemberLike", b =>
                {
                    b.Property<string>("SourseMemberId")
                        .HasColumnType("TEXT");

                    b.Property<string>("TargetMemberId")
                        .HasColumnType("TEXT");

                    b.HasKey("SourseMemberId", "TargetMemberId");
            ...
            modelBuilder.Entity("API.Entities.MemberLike", b =>
                {
                    b.HasOne("API.Entities.Member", "SourseMember")
                        .WithMany("LikedMembers")
                        .HasForeignKey("SourseMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
